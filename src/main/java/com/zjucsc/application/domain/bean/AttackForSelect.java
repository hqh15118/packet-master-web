...
@Data
public class AttackForSelect implements Serializable {
    ...
    public List<SavedAttackPacket> getSavedPackets() {
        return savedPackets;
    }

    public void setSavedPackets(List<SavedAttackPacket> savedPackets) {
        this.savedPackets = savedPackets;
    }

    public static class SavedAttackPacket implements Serializable{
        /**
         * timeStamp :  1
         * protocolName : 1
         * srcMac : 1
