...
import com.zjucsc.capture_main_distribute.bean.BadPacket;
import com.zjucsc.capture_main_distribute.bean.FvDimensionFilter;
import com.zjucsc.capture_main_distribute.bean.Rule;
...
import static com.zjucsc.common.common_config.PACKET_PROTOCOL.OTHER;
...
//            }
    ...
    private void setFilterMap(HashMap<String, HashMap<String, String>> allMap,
        ...
        if (fiveDimensionFilter.getProtocolId() != 0){
            String var = CaptureCommon.PROTOCOL_STR_TO_INT.get(fiveDimensionFilter.getProtocolId());
            /*
